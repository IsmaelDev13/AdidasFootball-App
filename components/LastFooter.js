...
function LastFooter() {
  return (
    <div className="w-full bg-gray-200 p-10 flex flex-col -mt-36 justify-evenly lg:flex-row font-serif  ">
      <div className="max-w-screen-sm   text-sm ">
        <h1 className="font-bold uppercase text-xs tracking-widest py-3">
      ...
      <div className="max-w-screen-sm   text-sm">
        <h1 className="font-bold uppercase tracking-widest text-xs py-3">
